...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player V3.0** \nI Can Play Radio / Music / YouTube Live In Channel & Group 24x7 Nonstop. Made with ❤️ By @DeVilXdy 😉!"
HELP_TEXT = """
💡 --**Setting Up**--:
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.lower() == "replay":
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/Classics0012"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/Classics002"),
            ],
            [
                InlineKeyboardButton("MORE BOTS", url="Classics0012"),
                InlineKeyboardButton("SOURCE CODE", url="https://te.legra.ph/file/1facd8b18af633fa20eaa.mp4"),
            ],
            [
        ...
        buttons = [
            ...
            [
                InlineKeyboardButton("MORE BOTS", url="https://t.me/Classics0012"),
                InlineKeyboardButton("SOURCE CODE", url="https://te.legra.ph/file/1facd8b18af633fa20eaa.mp4"),
            ],
            [
...
async def start(client, message):
    ...
    reply_markup = InlineKeyboardMarkup(buttons)
    m=await message.reply_photo(photo="https://graph.org/file/ac6b9ad447404863e32bd.jpg", caption=HOME_TEXT.format(message.from_user.first_name, message.from_user.id), reply_markup=reply_markup)
    await mp.delete(m)
