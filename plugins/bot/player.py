...
async def not_chat(_, m: Message):
    buttons = [
            ...
            [
                InlineKeyboardButton("🤖 MAKE YOUR OWN BOT 🤖", url="https://heroku.com/deploy?template=https://te.legra.ph/file/70111b0bc46fddf36333f.mp4"),
            ]
         ]
    k=await m.reply_photo(photo="https://graph.org/file/ac6b9ad447404863e32bd.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂️ But You Can Make Your Own Bot Like This From The [Source Code](https://te.legra.ph/file/70111b0bc46fddf36333f.mp4) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
